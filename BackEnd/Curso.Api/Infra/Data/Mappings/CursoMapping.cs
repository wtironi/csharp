...
namespace Curso.Api.Infra.Data.Mappings
{
    public class CursoMapping : IEntityTypeConfiguration<Cursos>
    {
        public void Configure(EntityTypeBuilder<Cursos> builder)
        {
            ...
            builder.HasKey(c => c.Codigo);//PK
            builder.Property(c => c.Codigo).ValueGeneratedOnAdd();//Autoincremet
            builder.Property(c => c.Nome);
            builder.Property(c => c.Descricao);
            builder.HasOne(c => c.Usuario)
                .WithMany().HasForeignKey(fk => fk.CodigoUsuario);//Fk da tabela do usuario
        }
    }
}
