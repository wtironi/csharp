...
namespace Pratica03
{
   class Program
   {
      static void Main(string[] args)
      {
         ...
         Console.WriteLine("{0} Multiplo(s) de 2", qtdMult02);
         Console.WriteLine("{0} Multiplo(s) de 3", qtdMult03);
         Console.WriteLine("{0} Multiplo(s) de 4", qtdMult04);
         Console.WriteLine("{0} Multiplo(s) de 5", qtdMult05);
